...
class Astrobee(object):
    ...
    def linearized_discrete_dynamics(self, x:np.ndarray, u:np.ndarray):
        """
        ATT: qua stiamo definendo in questo modo perché X va passato come matrice e ndarray è il formato per farlo
        ...
        u = np.array(u).reshape(1, 1) #dobbiamo includere in questo modo in quanto u deve essere un 1D array. prima era 0 array
